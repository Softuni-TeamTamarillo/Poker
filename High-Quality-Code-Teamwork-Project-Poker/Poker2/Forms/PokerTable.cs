...
namespace Poker2.Forms
{
    ...
    public partial class PokerTable : Form
    {
        ...
        /// </summary>        
        private double communityCardsRound;
        ...
        //private PictureBox[] playerMoney = new PictureBox[(MaximumCardsToBeDealt - 5)/2];
        ...
        public async Task ShuffleCards()
        {
            ...
            for (i = 0; i < MaximumCardsToBeDealt; i++)
            {
                ...
                if (i < 2)
                {
                    ...
                    //if (i == 0)
                    //{
                    //    this.playerMoney[i / 2 + 1] = new PictureBox();
                    //    playerMoney[i / 2 + 1].SizeMode = PictureBoxSizeMode.StretchImage;
                    //    playerMoney[i / 2 + 1].Height = 40;
                    //    playerMoney[i / 2 + 1].Width = 40;
                    //    this.Controls.Add(playerMoney[i / 2 + 1]);
                    //    playerMoney[i / 2 + 1].Name = "pictureboxChips" + i.ToString();
                    //    playerMoney[i / 2 + 1].Tag = i / 2 + 1;
                    //    playerMoney[i / 2 + 1].Image = Image.FromFile("Assets\\Chips\\10000.24999.png");
                    //    playerMoney[i / 2 + 1].Anchor = (AnchorStyles.Bottom);
                    //    this.playerMoney[this.i / 2 + 1].Visible = true;
                    //    this.playerMoney[this.i / 2 + 1].Location = new Point(horizontal + 180, vertical +25);
                    //}
       ...
       public void CheckWinners(double currentPlayerCategoryFactor, double currentPlayerRankFactor, string currentText, int chips, string lastly)
        ...
        public async Task AllIn()
        {
            ...
            var notFoldedOrAllIn = foldRegister.Count(x => x == false);

            //If only one player has not folded this turn
            //he is the winner
            if (notFoldedOrAllIn == 1)
            {
            ...
            if (notFoldedOrAllIn < 6 && notFoldedOrAllIn > 1 && communityCardsRound >= End)
            {
                await FinishGame(2);
            }
        }
        ...
        /// <param name="botFoldOrIsAllIn">Parameter, that indicates current player has folded or is all in</param>
        ...
        public void AIEngine(int card1, int card2, ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, int botName, double botHandRankFactor, double botHandCategoryFactor)
        {
            ...
            if (!botFoldOrIsAllIn)
            {
                ...
                {
                    HighCard(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botHandRankFactor);
                }

                if (botHandCategoryFactor == 0)
                {
                    PairTable(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botHandRankFactor);
                }

                if (botHandCategoryFactor == 1)
                {
                    PairHand(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botHandRankFactor);
                }

                if (botHandCategoryFactor == 2)
                {
                    TwoPair(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botHandRankFactor);
                }

                if (botHandCategoryFactor == 3)
                {
                    ThreeOfAKind(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botName, botHandRankFactor);
                }

                if (botHandCategoryFactor == 4)
                {
                    Straight(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botName, botHandRankFactor);
                }

                if (botHandCategoryFactor == 5 || botHandCategoryFactor == 5.5)
                {
                    Flush(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botName, botHandRankFactor);
                }

                if (botHandCategoryFactor == 6)
                {
                    FullHouse(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botName, botHandRankFactor);
                }

                if (botHandCategoryFactor == 7)
                {
                    FourOfAKind(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botName, botHandRankFactor);
                }

                if (botHandCategoryFactor == 8 || botHandCategoryFactor == 9)
                {
                    StraightFlush(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botName, botHandRankFactor);
                }
            }
        ...
        /// <param name="botFoldOrIsAllIn">Parameter that indicates if current bot has folded or is all in</param>
        /// <param name="botStatus">The status text of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>        
        public void HighCard(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, double botHandRankFactor)
        {
            HP(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botHandRankFactor, 20, 25);
        }
        ...
        /// <param name="botStatus">The status text of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>        
        public void PairTable(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, double botHandRankFactor)
        {
            HP(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botHandRankFactor, 16, 25);
        }
        ...
        /// <param name="botStatus">The status text of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>        
        public void PairHand(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, double botHandRankFactor)
        {
            ...
            {
                PH(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, callParameter, 6, raiseParameter);
            }

            if (botHandRankFactor <= 139 && botHandRankFactor >= 128)
            {
                PH(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, callParameter, 7, raiseParameter);
            }

            if (botHandRankFactor < 128 && botHandRankFactor >= 101)
            {
                PH(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, callParameter, 9, raiseParameter);
            }
        }
        ...
        /// <param name="botStatus">The status text of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>       
        public void TwoPair(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, double botHandRankFactor)
        {
            ...
            {
                PH(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, callParameter, 3, raiseParameter);
            }

            if (botHandRankFactor <= 244 && botHandRankFactor >= 234)
            {
                PH(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, callParameter, 4, raiseParameter);
            }
        ...
        /// <param name="botName">The name of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>          
        public void ThreeOfAKind(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, int botName, double botHandRankFactor)
        {
            //Creates a generator for parameters to use in BotChoiceFormula formula for raise calculation and call calculation
            Random parameterGenerator = new Random();
            ...
            {
                Smooth(ref botChips, ref botTurn, ref botFoldOrIsAllIn, botStatus, botName, callParameter, raiseParameter);
            }
        ...
        /// <param name="botName">The name of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>     
        public void Straight(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, int botName, double botHandRankFactor)
        {
            //Creates a generator for parameters to use in BotChoiceFormula formula for raise calculation and call calculation
            Random parameterGenerator = new Random();
        ...
        /// <param name="botName">The name of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>    
        public void Flush(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, int botName, double botHandRankFactor)
        {
            //Creates a generator for parameters to use in BotChoiceFormula formula for raise calculation and call calculation
            Random parameterGenerator = new Random();
        ...
        /// <param name="botName">The name of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>       
        public void FullHouse(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, int botName, double botHandRankFactor)
        {
            //Creates a generator for parameters to use in BotChoiceFormula formula for raise calculation and call calculation
            Random parameterGenerator = new Random();
        ...
        /// <param name="botName">The name of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>       
        public void FourOfAKind(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, int botName, double botHandRankFactor)
        {
            //Creates a generator for parameters to use in BotChoiceFormula formula for raise calculation and call calculation
            Random parameterGenerator = new Random();
        ...
        /// <param name="botName">The name of the bot</param>
        /// <param name="botHandRankFactor">The bot's hand category factor</param>        
        public void StraightFlush(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, int botName, double botHandRankFactor)
        {
            //Creates a generator for parameters to use in BotChoiceFormula formula for raise calculation and call calculation
            Random parameterGenerator = new Random();
        ...
        /// <param name="botFoldOrIsAllIn">Parameter that indicates if current bot has folded or is all in</param>
        /// <param name="botStatus">The status text of the bot</param>
        public void Fold(ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus)
        {
            isBetRaised = false;
            botStatus.Text = "Fold";
            botTurn = false;
            botFoldOrIsAllIn = true;
        }
        ...
        public void HP(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, double botHandRankFactor, int n, int n1)
        {
            ...
            if (callAmount > 0)
            {
                ...
                if (randChoice == 1)
                {
                    ...
                    {
                        Fold(ref botTurn, ref botFoldOrIsAllIn, botStatus);
                    }
                }
        ...
        public void PH(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, int n, int n1, int randGenerator)
        {
        ...
        /// <param name="n">The n parameter</param>
        /// <param name="randGenerator">The randGenerator parameter</param>        
        public void Smooth(ref int botChips, ref bool botTurn, ref bool botFoldOrIsAllIn, Label botStatus, int botName, int n, int randGenerator)
        {
        ...
        public async void timer_Tick(object sender, object e)
        {
            ...
            //Time is not expired and the  is refreshed
        ...
        /// Describes a series of changes in four variable , 
            ...
            if (textboxRaise.Text != string.Empty && int.TryParse(textboxRaise.Text, out parsedValue))
            {
                ...
                if (this.playerChips > callAmount)
                {
                    ...
                    if (this.raiseAmount * 2 > int.Parse(textboxRaise.Text))
                    {
                        ...
                        MessageBox.Show("You must Raise at least twice as the current Raise amount !");
                        return;
                    }
