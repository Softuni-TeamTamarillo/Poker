namespace PokerTests.FakeModelsSevenCards
{
    ...
    public class FakePlayerAllCardsDifferentWithoutMatchingSecondHandCardHigher : IPlayer
    {
        public FakePlayerAllCardsDifferentWithoutMatchingSecondHandCardHigher()
        {
