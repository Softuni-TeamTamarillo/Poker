namespace PokerTests.FakeModelsSevenCards
{
    ...
    public class FakePlayerAllCardsDifferentWithoutMatching : IPlayer
    {
        public FakePlayerAllCardsDifferentWithoutMatching()
        {
            this.FirstCard = new Card() { Rank = Rank.Jack, Suit = Suit.Hearts };
            this.SecondCard = new Card() { Rank = Rank.Six, Suit = Suit.Spades };
